  ...
  render() {
    ...
    return (
      <div className="container">
        ...
        <Slider className="slider-big" {...settings}>
         <div>
           <p className="slider-text">“I was fortunate enough to be introduced to Deniz. I saw him give a presentation to a Division 1 swim team and I was highly impressed with his knowledge of swimming and his knowledge of connecting out of the pool work with the in the pool necessities of a swimmer.
         ...
         <div>
           <p className="slider-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
           <h4 className="slider-header">Jonas Persson, Head Coach University of Toledo | Workshop</h4>
        </div>
         <div>
           <p className="slider-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
           <h4 className="slider-header">Thibault Capitane, French Pro Swimmer, 1st time World Championship qualifier | Online Training</h4>
        </div>
       </Slider>
      <div className="home-header">
        <h1>Contact</h1>
