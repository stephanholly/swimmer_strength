                ...
                <div className="ul-training1">
                  ...
                  <div className="training-descriptions">
                    <div className="az-training-button">
                      <a href="http://localhost:3000/aztraining-mesa" className="training-link-text">Train at our Mesa Location</a>
                    </div>
                    <div className="az-training-button">
                      <a href="http://localhost:3000/aztraining-tempe" className="training-link-text">Train at our Tempe Location</a>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="training-other">
                <h1 className="training-header-sub">Online-based Training</h1>
                  <div className="ul-training1">
                    ...
                    <a href="http://localhost:3000/onlinetraining" className="training-link-text2">sign up here</a>
                    </div>
                </div>
              </div>
            </div>
